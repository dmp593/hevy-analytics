    ...
    <x-dropdown :align="$align" width="48">
        <x-slot name="trigger">
            <button type="button"
                    ...
                    class="inline-flex min-h-11 items-center gap-1 whitespace-nowrap rounded-md px-2 py-2 text-sm font-medium text-muted transition hover:text-body focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand">
