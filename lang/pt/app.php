...
return [
    ...
    'billing' => [
        ...
        'comped_body' => 'Tens acesso completo oferecido, sem data de fim: todas as páginas, todo o teu histórico, nada a pagar.',
        'comped_body_until' => 'Tens acesso completo oferecido até :date: todas as páginas, todo o teu histórico, nada a pagar.',
    ...
    'admin' => [
        ...
        'status' => 'Estado',
        'ends' => 'Termina',
        'account_disabled' => 'Esta conta foi desativada. Contacta o suporte se achares que é um engano.',
        'disabled' => ':name foi desativada.',
        'enabled' => ':name foi reativada.',
        'disabled_since' => 'Conta desativada desde :date.',
        'disable' => 'Desativar conta',
        'disable_note' => 'Bloqueia o login e termina sessões ativas. Os dados ficam; reversível.',
        'enable' => 'Reativar conta',
        'delete' => 'Apagar conta',
        'delete_note' => 'Permanente: remove a conta, os dados e as fotografias — a mesma eliminação que a pessoa podia fazer sozinha.',
        'deleted' => ':name foi apagada.',
        'deleted_detail' => 'Conta apagada: :email',
    ...
    'body' => [
        ...
        'waist_hip' => 'Cintura / anca',
        'rfm' => 'RFM (gordura por fita)',
    ...
    'compare' => [
        ...
        'vs_goal' => 'As variações de peso e de massa gorda são lidas contra o teu objetivo (:goal): a favor é verde, contra é vermelho, e uma variação abaixo de cerca de 1% do peso corporal (ou 1 ponto de massa gorda) conta como estável — isso é água, refeições e ruído de medição. Num bulk, algum ganho de gordura é o custo aceite, por isso só é sinalizado a âmbar acima de 2 pontos, nunca a vermelho. A seta e o sinal dizem sempre o mesmo que a cor.',
    ...
    'alerts' => [
        ...
        'volume_spike' => 'Salto brusco no volume de treino',
    ...
    'tips' => [
        ...
        'waist_hip' => 'A cintura a dividir pela anca. A OMS assinala 0,90+ nos homens e 0,85+ nas mulheres como risco cardiometabólico elevado; a cor precisa do sexo no perfil, o número não.',
